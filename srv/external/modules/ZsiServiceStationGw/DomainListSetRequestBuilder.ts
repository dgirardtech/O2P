 ...
 */
export class DomainListSetRequestBuilder<
...
> extends RequestBuilder<DomainListSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<DomainListSet<T>, T> {
    return new GetAllRequestBuilder<DomainListSet<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<DomainListSet<T>, T>(this.entityApi, {
