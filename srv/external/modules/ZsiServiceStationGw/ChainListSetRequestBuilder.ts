 ...
 */
export class ChainListSetRequestBuilder<
...
> extends RequestBuilder<ChainListSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ChainListSet<T>, T> {
    return new GetAllRequestBuilder<ChainListSet<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ChainListSet<T>, T>(this.entityApi, {
      ChainCode: chainCode
    });
  }
}
