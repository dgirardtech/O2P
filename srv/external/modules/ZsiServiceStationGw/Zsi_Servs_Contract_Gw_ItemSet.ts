 ...
 */
export class Zsi_Servs_Contract_Gw_ItemSet<
  ...
  implements Zsi_Servs_Contract_Gw_ItemSetType<T>
{
   ...
   */
  static _entityName = 'ZSI_SERVS_CONTRACT_GW_ITEMSet';
  /**
   ...
   * Contract Number.
   */
  declare contractNumber: DeserializedType<T, 'Edm.String'>;
  /**
   * Data.
   */
  declare contractStart: DeserializedType<T, 'Edm.DateTime'>;
  /**
   * Data.
   */
  declare contractEnd: DeserializedType<T, 'Edm.DateTime'>;
  /**
   * Validity Period.
   */
  declare validityPeriod: DeserializedType<T, 'Edm.String'>;
  /**
   * Validity Period Desc.
   */
  declare validityPeriodDesc: DeserializedType<T, 'Edm.String'>;
