 ...
 */
export class Zsi_Servs_Contract_Gw_ItemSetRequestBuilder<
...
> extends RequestBuilder<Zsi_Servs_Contract_Gw_ItemSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Zsi_Servs_Contract_Gw_ItemSet<T>, T> {
    return new GetAllRequestBuilder<Zsi_Servs_Contract_Gw_ItemSet<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Zsi_Servs_Contract_Gw_ItemSet<T>, T>(
      this.entityApi,
      {
        SERV_SID: servSid,
        SALES_ORG: salesOrg,
