...
exports.Zsi_Servs_Dealer_GwSetApi = void 0;
/*
 * Copyright (c) 2024 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const Zsi_Servs_Dealer_GwSet_1 = require("./Zsi_Servs_Dealer_GwSet");
const Zsi_Servs_Dealer_GwSetRequestBuilder_1 = require("./Zsi_Servs_Dealer_GwSetRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class Zsi_Servs_Dealer_GwSetApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Zsi_Servs_Dealer_GwSet_1.Zsi_Servs_Dealer_GwSet;
    ...
    requestBuilder() {
        return new Zsi_Servs_Dealer_GwSetRequestBuilder_1.Zsi_Servs_Dealer_GwSetRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Zsi_Servs_Dealer_GwSet_1.Zsi_Servs_Dealer_GwSet, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Zsi_Servs_Dealer_GwSet_1.Zsi_Servs_Dealer_GwSet)
            };
        }
        return this._schema;
    }
}
exports.Zsi_Servs_Dealer_GwSetApi = Zsi_Servs_Dealer_GwSetApi;
//# sourceMappingURL=Zsi_Servs_Dealer_GwSetApi.js.map