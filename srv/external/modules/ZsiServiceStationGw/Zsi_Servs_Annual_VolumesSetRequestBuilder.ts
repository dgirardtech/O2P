 ...
 */
export class Zsi_Servs_Annual_VolumesSetRequestBuilder<
...
> extends RequestBuilder<Zsi_Servs_Annual_VolumesSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Zsi_Servs_Annual_VolumesSet<T>, T> {
    return new GetAllRequestBuilder<Zsi_Servs_Annual_VolumesSet<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Zsi_Servs_Annual_VolumesSet<T>, T>(
      this.entityApi,
      {
        SERV_SID: servSid,
        SALES_ORG: salesOrg,
