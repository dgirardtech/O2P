 ...
 */
export class ProgramCodeSetRequestBuilder<
...
> extends RequestBuilder<ProgramCodeSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ProgramCodeSet<T>, T> {
    return new GetAllRequestBuilder<ProgramCodeSet<T>, T>(this.entityApi);
  }
   ...
   */
  create(
    entity: ProgramCodeSet<T>
  ): CreateRequestBuilder<ProgramCodeSet<T>, T> {
    return new CreateRequestBuilder<ProgramCodeSet<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ProgramCodeSet<T>, T>(this.entityApi, {
      Program: program,
