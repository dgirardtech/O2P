 ...
 */
export class AmountCurrencySetRequestBuilder<
...
> extends RequestBuilder<AmountCurrencySet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<AmountCurrencySet<T>, T> {
    return new GetAllRequestBuilder<AmountCurrencySet<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<AmountCurrencySet<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AmountCurrencySet<T>, T>(this.entityApi, {
      Date: date,
