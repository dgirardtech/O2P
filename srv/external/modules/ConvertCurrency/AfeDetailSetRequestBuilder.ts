 ...
 */
export class AfeDetailSetRequestBuilder<
...
> extends RequestBuilder<AfeDetailSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<AfeDetailSet<T>, T> {
    return new GetAllRequestBuilder<AfeDetailSet<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AfeDetailSet<T>, T>(this.entityApi, {
