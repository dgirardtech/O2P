...
exports.WorkflowInstancesApi = {
     ...
     */
    getInstance: (workflowInstanceId, queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}', {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getInstanceContext: (workflowInstanceId, body) => new openapi_1.OpenApiRequestBuilder('patch', '/v1/workflow-instances/{workflowInstanceId}/context', {
        pathParameters: { workflowInstanceId },
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstances: (queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances', {
        queryParameters
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    createV1WorkflowInstances: (body) => new openapi_1.OpenApiRequestBuilder('post', '/v1/workflow-instances', {
        body
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesAttributesByWorkflowInstanceId: (workflowInstanceId) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/attributes', {
        pathParameters: { workflowInstanceId }
    }),
    /**
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesExecutionLogsByWorkflowInstanceId: (workflowInstanceId) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}/execution-logs', {
        pathParameters: { workflowInstanceId }
    })
};
